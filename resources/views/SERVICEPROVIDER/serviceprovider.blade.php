    ...
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #081621;">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center justify-content-start">
                <a class="navbar-brand text-white font-weight-bold" href="{{ route('serviceproviderhome') }}">
                    Service লাগবে ?
                </a>
            </div>
            ...
            <div class="d-flex align-items-center">
                @if (Auth::guard('serviceprovider')->check())
                    <div class="dropdown text-center">
                        <a class="btn btn-outline-light dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            aria-expanded="false">
                            <i class="fa-solid fa-user"></i> {{ Auth::guard('serviceprovider')->user()->name }}
                        </a>

                        <div class="dropdown-menu dropdown-menu-right bg-transparent border-0">
                            <div class="d-flex justify-content-center ml-5">
                                <form id="logoutForm" action="{{ route('ServiceproviderLogout') }}" method="POST">
                                    @csrf
                ...
                @else
                    <a class="btn btn-outline-light ml-2" href="{{ route('serviceproviderlogin') }}">Sign In</a>
                @endif
            </div>
        </div>
    </nav>
            ...
            <div class="row text-center text-md-left">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('serviceproviderhome') }}"
                                class="text-white text-decoration-none">Home</a>
                        </li>
                        <li><a href="{{ route('serviceproviderprofile') }}"
                                class="text-white text-decoration-none">Profile</a></li>
                        <li><a href="{{ route('serviceproviderlogin') }}" class="text-white text-decoration-none">Sign
                                In</a>
                        </li>
                    </ul>
                </div>
